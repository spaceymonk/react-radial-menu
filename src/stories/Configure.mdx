...
<Title />
<Subtitle>React Radial Menu</Subtitle>

Radial menu with animations and nested sub menu support for React. You can use it
for context menu or as a menu for your mobile app.
